...
const BreakGlassIntroductionStyled = styled(Box)(({ theme }) => ({
  display: "flex",
  flexDirection: "row",
  gap: theme.spacing(4),
...
const BreakGlassIntroduction = (props) => {
  const {
    data: { title, subtitle, description, photo },
  } = props;

  return (
    <BreakGlassIntroductionStyled>
...
BreakGlassIntroduction.propTypes = {
...
export default BreakGlassIntroduction;
